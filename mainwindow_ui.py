...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.changpass_label.setStyleSheet("color: #E8E9EB")
        self.onlinenum_label.setStyleSheet("color: #E8E9EB")
        self.login_button.setStyleSheet("QPushButton {background-color: #394674; color: #E8E9EB;}")
        self.send_button.setStyleSheet("QPushButton {background-color: #394674; color: #E8E9EB;}")
        self.updatepass_button.setStyleSheet("QPushButton {background-color: #394674; color: #E8E9EB;}")
        self.message_line.setStyleSheet("QLineEdit {background-color: #E8E9EB; color: #374B72;}")
        ...
        self.changepass_line.setStyleSheet("QLineEdit {background-color: #E8E9EB; color: #374B72;}")
        self.chat_line.setStyleSheet("QTextBrowser {background-color: #E8E9EB; color: #3E3E3E;}")
