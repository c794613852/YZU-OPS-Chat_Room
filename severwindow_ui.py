...
class Ui_SeverWindow(object):
    def setupUi(self, SeverWindow):
        ...
        self.det_button.setGeometry(QtCore.QRect(10, 520, 321, 31))
        ...
        self.checkBox1.setGeometry(QtCore.QRect(20, 90, 301, 16))
    ...
    def retranslateUi(self, SeverWindow):
        ...
        self.det_button.setText(_translate("SeverWindow", "Det"))
